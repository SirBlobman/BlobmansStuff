...
public abstract class CustomCreeper extends EntityMob {
	private static final DataParameter<Integer> STATE = EntityDataManager.<Integer>createKey(CustomCreeper.class, DataSerializers.VARINT);
	private static final DataParameter<Boolean> POWERED = EntityDataManager.<Boolean>createKey(CustomCreeper.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> IGNITED = EntityDataManager.<Boolean>createKey(CustomCreeper.class, DataSerializers.BOOLEAN);
	...
	public static void registerFixesCreeper(DataFixer fixer) {
		EntityLiving.registerFixesMob(fixer, CustomCreeper.class);
	}
		...
		if (this.world.getGameRules().getBoolean("doMobLoot")) {
			if (cause.getTrueSource() instanceof EntitySkeleton) {
				...
				this.dropItem(Item.getItemById(k), 1);
					...
					&& ((EntityCreeper) cause.getTrueSource()).isAIEnabled()) {
